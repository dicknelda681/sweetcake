...
<title>Sweet Moments Bakery | Turning Every Bite into Beautiful Memories</title>
<meta name="description" content="Sweet Moments Bakery creates delicious cakes and desserts that turn your special moments into beautiful memories. Freshly baked with love, just for you.">
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header__top__inner">
                            ...
                            <a href="malto:Sweetcake@support.com"><span style="color:#111111; font-weight:500;">Sweetcake@support.com</span></a>
                            </div>
                            ...
                            <div class="header__top__right">
                                <div class="header__top__right__links">
                                  <a href="malto:+1 (540) 615-2198"><span style="color:#111111; font-weight:500;">+1 (540) 615-2198</span></a>
                                </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                <h2>Have a special occasion coming up or craving something sweet?</h2>
            ...
            <div class="hero__item set-bg" data-setbg="img/hero/hero-1.jpg">
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                <h2>Questions, custom orders, or cake ideas?</h2>
                                <a href="#" class="primary-btn">Our cakes</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="class__form">
                        <div class="section-title">
                            ...
                            <h2>Made with love,  <br />crafted by our own hands</h2>
                        </div>
                        <form action="#">
    ...
    <div class="col-lg-6">
        <div class="testimonial__item">
            ...
            <p>The photos were absolutely stunning. Every moment was captured beautifully with great attention to detail.</p>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="testimonial__item">
            ...
            <p>Very professional and friendly team. The final photos exceeded our expectations.</p>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="testimonial__item">
            ...
            <p>They made our special day even more memorable. Truly amazing photography work.</p>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="testimonial__item">
            ...
            <p>Outstanding service and incredible quality. I would highly recommend them to anyone.</p>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="testimonial__item">
            ...
            <p>Such a smooth experience from start to finish. The results were simply beautiful.</p>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="testimonial__item">
            ...
            <p>Creative, reliable, and extremely talented. We are in love with the final photos.</p>
        </div>
    </div>
                ...
                <div class="col-lg-4 p-0">
                    <div class="instagram__text">
                        <div class="section-title">
                            ...
                            <h2>Sweet moments, saved as beautiful memories.</h2>
                        </div>
    ...
    <footer class="footer set-bg" data-setbg="img/footer-bg.jpg">
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <p class="copyright__text text-white">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved </p>
                  </div>
                  <div class="col-lg-5">
